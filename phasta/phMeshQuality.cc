...
// update the coordinates of current mesh
    ...
    if (in.simmetrixMesh == 1)
    {
      ...
      sztype = V_size(meshVertex, size, anisosize);
...
// print info
    printf("size field type: %d\n",sztype);
    printf("vertex %d: mag = (%f,%f,%f)\n",counter,v_mag[0],v_mag[1],v_mag[2]);
    printf("    %f,%f,%f\n",anisosize[0][0], anisosize[1][0], anisosize[2][0]);
    printf("    %f,%f,%f\n",anisosize[0][1], anisosize[1][1], anisosize[2][1]);
    printf("    %f,%f,%f\n",anisosize[0][2], anisosize[1][2], anisosize[2][2]);
