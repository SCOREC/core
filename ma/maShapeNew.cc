...
void FixShape::fixTwoLargeAngles(Entity* tet, Entity* problemEnts[4])
{
...
void FixShape::fixThreeLargeAngles(Entity* tet, Entity* problemEnts[4])
{
  Entity* tetEdges[6];
...
void FixShape::printBadShape(Entity* badTet)
{
  Entity* worstTri;
  Entity* problemEnts[4];
